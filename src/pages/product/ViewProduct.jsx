              ...
              <div className="text-center items-center justify-center w-full py-8">
                <TabsContent value="Description" className="w-full">
                  <p className="text-left text-gray-500">
                    ...
                    Quidem sed aut dolorem placeat! Recusandae, voluptate
                    inventore repellat sequi, dolor quas ut tenetur perferendis
                    voluptas praesentium voluptates repudiandae eius accusantium
                    nostrum! Repellat ab exercitationem cum doloribus assumenda
                    dignissimos hic eveniet debitis maiores, esse fuga corporis
                    reprehenderit! Iusto, consequatur. Officia quibusdam eos
                    exercitationem vitae eligendi libero iure aliquid
                    voluptatibus autem, blanditiis adipisci.
                  </p>
                  ...
                  <ul className="pt-4">
                    ...
                    <li className="pt-2">
                      <div className="flex items-center gap-4">
                        <IoMdCheckmark />
                        <span className="text-left text-gray-500">
                          Quos corporis quibusdam assumenda eligendi non
                          ratione.
                        </span>
                      </div>
                    </li>
